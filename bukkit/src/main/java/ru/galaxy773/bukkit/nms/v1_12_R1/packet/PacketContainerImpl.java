package ru.galaxy773.bukkit.nms.v1_12_R1.packet;
...
import ru.galaxy773.bukkit.nms.v1_12_R1.GWorldBorderImpl;
import ru.galaxy773.bukkit.nms.v1_12_R1.packet.entity.*;
import ru.galaxy773.bukkit.nms.v1_12_R1.packet.entityplayer.PacketBedImpl;
import ru.galaxy773.bukkit.nms.v1_12_R1.packet.entityplayer.PacketCameraImpl;
import ru.galaxy773.bukkit.nms.v1_12_R1.packet.entityplayer.PacketNamedEntitySpawnImpl;
import ru.galaxy773.bukkit.nms.v1_12_R1.packet.entityplayer.PacketPlayerInfoImpl;
import ru.galaxy773.bukkit.nms.v1_12_R1.packet.scoreboard.PacketDisplayObjectiveImpl;
import ru.galaxy773.bukkit.nms.v1_12_R1.packet.scoreboard.PacketScoreBoardTeamImpl;
import ru.galaxy773.bukkit.nms.v1_12_R1.packet.scoreboard.PacketScoreboardObjectiveImpl;
import ru.galaxy773.bukkit.nms.v1_12_R1.packet.scoreboard.PacketScoreboardScoreImpl;
import ru.galaxy773.bukkit.nms.v1_12_R1.packet.world.PacketWorldParticlesImpl;
...
public class PacketContainerImpl implements PacketContainer {
    ...
    @Override
    public void sendPacket(Player player, GPacket... dPackets) {
    ...
    public void sendChatPacket(Player player, String message,
        ...
        PacketPlayOutChat packetPlayOutChat = new PacketPlayOutChat(IChatBaseComponent.ChatSerializer
                .a(messageType == ru.galaxy773.bukkit.nms.types.ChatMessageType.GAME_INFO
