...
public abstract class GEntityBase<T extends net.minecraft.server.v1_12_R1.Entity> implements GEntity {
    ...
    @Override
    public void setPassenger(GEntity gEntity) {
        removePassenger();
        net.minecraft.server.v1_12_R1.Entity entity = ((GEntityBase<?>) gEntity).getEntityNms();
