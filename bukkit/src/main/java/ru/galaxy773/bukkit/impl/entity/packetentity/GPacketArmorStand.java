...
import ru.galaxy773.bukkit.impl.entity.packetentity.base.GPacketEntityLivingBase;
...
import ru.galaxy773.bukkit.impl.entity.packetentity.packets.entity.WrapperPlayServerMount;

public final class GPacketArmorStand extends GPacketEntityLivingBase implements CustomStand {

    private final StandManager standManager;
    @Getter
    private final JavaPlugin plugin;
    private GPacketEntityBase passenger;

    public GPacketArmorStand(JavaPlugin javaPlugin, StandManager standManager, Location location) {
        super(location);
    ...
    public void setItemPassenger(ItemStack itemPassenger) {
        ...
        passenger = new GPacketEntityItem(location, itemPassenger);
