...
import ru.galaxy773.bukkit.impl.effect.glow.CraftPlayerGlowing;
import ru.galaxy773.bukkit.impl.effect.glow.GlowListener;
import ru.galaxy773.bukkit.impl.effect.glow.GlowManager;
...
public class ParticleAPIImpl implements ParticleAPI {
    ...
    public ParticleAPIImpl() {
        this.firework = new CraftFireworkListener();
    ...
    public PlayerGlowing getOrCreateGlowing(Player player, List<Player> players) {
        ...
        for (Player other : players) {
            glowManager.getMemberGlowing().put(other.getName(), craftPlayerGlowing);
        }
    ...
    public PlayerGlowing getByMember(Player member) {
        return glowManager.getMemberGlowing().get(member.getName());
    }
    ...
    public void resetGlowing(Player player) {
        ...
        CraftPlayerGlowing glowing = glowManager.getGlowings().remove(player.getName());
        if (glowing == null) {
            return;
        }
